...
- parentGuide: 한국어 150~230자. 책에서 무엇을 함께 볼지 1개, 정답이 하나가 아니며 예/아니요나 한 단어로 끝나지 않는 직접 인용 질문 2개, 아이의 일상 경험과 잇는 단서 1개를 포함합니다. 부모가 답을 재촉하거나 고치지 말고 기다린 뒤 아이의 말을 한두 단어 확장해 되돌려주도록 짧게 안내합니다.
- activities: 한국어 150~230자. 책의 핵심 내용과 직접 연결된 놀이 1개만 제안합니다. "준비물:"과 "방법:"을 포함하고, 집에서 쉽게 구하는 안전한 준비물은 최대 3개, 방법은 2~3단계로 씁니다. 아이가 선택·설명·이야기 만들기를 주도하게 하며 역할놀이, 움직임, 오감 탐색 중 책에 자연스러운 방식을 활용합니다.
