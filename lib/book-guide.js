...
const STRATEGY_SIGNALS = Object.freeze({
  '그림 단서 찾기': Object.freeze([
    ...
    [/색감|색채|조형|명화|시각적|그림으로\s*(?:전개|구성|표현)/u, 4]
  ]),
  '예측하고 확인하기': Object.freeze([
    [/수수께끼|반전|예상치|다음\s*장면|결말을\s*상상/u, 6],
    [/갑자기|과연|비밀|나타난다|맞닥뜨/u, 3]
  ]),
  '순서 다시 말하기': Object.freeze([
    [/만드는\s*과정|만들기\s*과정|전\s*과정|단계별|차례대로|순서대로|완성하는\s*과정/u, 7],
    [/여정|여행|모험|길을\s*나서|떠나|바깥세상|밖으로\s*나/u, 5],
    [/준비를\s*하|여러\s*사건|에피소드|처음부터\s*끝|누적|반복\s*구조|과정/u, 3]
  ]),
  ...
  '소리와 말놀이': Object.freeze([
    [/의성어|의태어|말놀이|운율|반복구/u, 7],
    [/입말|말의\s*리듬|소리\s*표현|리듬감/u, 4]
  ]),
