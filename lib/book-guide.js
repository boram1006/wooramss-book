...
- response: 아이의 답 다음에 부모가 할 구체적인 행동을 35~60자의 "~해 보세요" 또는 "~해 주세요" 문장으로 씁니다. bookAnchor를 그대로 한 번 포함하고 필수 전략을 실제로 실행합니다. 모든 책에 통용되는 '잠깐 기다리기', '한두 단어 덧붙이기', '말을 확장해 되돌려주기'를 쓰지 않습니다. "아이의 답을 듣고" 같은 공통 도입 대신 책에서 곧바로 할 행동으로 시작합니다.
...
function assessGuideQuality(guide) {
  ...
  if (/말하게\s*하|시키|유도/u.test(response)) issues.push('directive_response');
