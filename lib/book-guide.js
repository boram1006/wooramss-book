...
- focus: 부모가 함께 살펴볼 책 속 대상·장면·표현을 25~55자로 씁니다.
- question1, question2: 아이가 자기 말로 답할 수 있는 서로 다른 기능의 열린 질문을 각각 한 문장으로 씁니다. 관찰, 예측, 회상, 근거 찾기, 낱말, 인물 관점, 경험 연결 중 선택한 전략에 맞는 두 기능을 고릅니다.
- response: 아이의 답 다음에 부모가 할 구체적인 행동을 35~75자로 씁니다. 선택한 전략을 실제로 실행하고 focus의 구체적 대상과 연결합니다. 모든 책에 통용되는 '잠깐 기다리기', '한두 단어 덧붙이기', '말을 확장해 되돌려주기'를 쓰지 않습니다.
